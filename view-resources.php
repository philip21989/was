...
<html lang="en">
    ...
    <?php include_once(INC.'/header.php'); ?>   
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li>
                <a href="javascript:">Manage Resources</a>
              </li>
              <li class="active">View Resources List</li>
            </ul><!-- /.breadcrumb -->
  ...
  function get_datatable()
  {
    ...
    $.ajax({
      method:'POST',
      url:'<?php echo AJAX;?>/view-list-resources.php',
      data:{username:username,email:email}
    }).success(function(msg){
      if(msg=='empty')
        $('#datatable-data').html('<h3 class="red align-center">No Resources available</h3>');
      else
      {
  ...
  { 
    ...
    $.ajax({
          method:'POST',
          url:'<?php echo AJAX;?>/get_resource_info.php',
          data:{cid:cid}
        }).success(function(msg){
