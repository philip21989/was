<?php 
  ...
  if(isset($active_admin_user) && $active_admin_user)
    $parms['reporting']=$_SESSION['username'];
  $get_all_resources=$user_op_obj->get_users($parms,false,['resource'],'all','0');
?>
<?php if(is_array($get_all_resources) && count($get_all_resources)>0){?>
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="pages_table">
                          <?php 
                            foreach ($get_all_resources as $row) {
                            ...
                            <tr id="content_row_<?php echo $row['id'];?>">
                              ...
                              <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                  ...
                                  <a class="grey" href="<?php echo SITE_URL;?>/manage-resource-user/<?php echo $row['username'];?> " title="Update resource User">
                                ...
                                <div class="hidden-md hidden-lg">
                                  <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                      ...
                                      <li>
                                        <a href="<?php echo SITE_URL;?>/manage-resource-user/<?php echo $row['username'];?>" class="tooltip-success" data-rel="tooltip" title="Update">
                                          <span class="grey">
