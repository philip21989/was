...
$this_sub_module_name='';
 ...
 if(!empty($_POST))
 {  
   $status=$user_op_obj->save_admin_user($_POST);
    ...
    }else
    {
      ...
      echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0;URL=".SITE_URL."/view-admins\">";
      exit;
    }
 }
  ...
  if(empty($get_user_data))
  {
    ...
    $_SESSION['status_dis_type']='error';
      echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0;URL=".SITE_URL."/\">";
      exit;
  }else if($get_user_data[0]->user_type!='admin')
  {
    $_SESSION['status_dis']='User not an admin';
    $_SESSION['status_dis_type']='error';
      echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0;URL=".SITE_URL."/\">";
      exit;
  }
  ...
  $mode ='add';
    ...
    $this_page_name=($mode=='add')?'manage-admin-user':'';
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8" />
    <title><?php echo ucfirst($mode);?> Admin User - <?php echo META_TITLE;?></title>
    ...
    <?php include_once(INC.'/header.php'); ?>   
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
              ...
              <li>
                <a href="<?php echo SITE_URL; ?>/view-blocks">Manage Admins</a>
              </li>

              <li class="active"><?php echo ucfirst($mode);?> Admin</li>
            </ul><!-- /.breadcrumb -->
                      ...
                      <div id="fuelux-wizard-container">
                        ...
                        <div class="step-content pos-rel">
                          <div class="step-pane active" data-step="1">
                            <h3 class="lighter block green"><?php echo ucfirst($mode);?> <?php echo (isset($_REQUEST['username']))?$get_user_data[0]->first_name:'';?> Admin</h3>
                           ...
                           <div class="space-8"></div>
                                ...
                                <div class="col-md-offset-3 col-md-9">
                                  ...
                                  &nbsp; &nbsp; &nbsp;
                                  <input type="button" name="Back" value="Back" onclick="window.location.href='<?php echo SITE_URL; ?>/view-admins'" class="btn btn-cancel">
                                </div>
                              </div>
                            </form>
                          </div>
